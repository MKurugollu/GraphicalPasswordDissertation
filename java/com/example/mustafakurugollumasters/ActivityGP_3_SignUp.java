...
public class ActivityGP_3_SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_p_3__sign_up);

        nextButton = (Button)findViewById(R.id.gp3SignUpNext);
        myUsername = (EditText)findViewById(R.id.gp3UsernameField_signup);
    ...
    public void openActivityGP_1_SignUpPassword() {
        Intent intent = new Intent(this, ActivityGP_3_SignUpPassword.class);
