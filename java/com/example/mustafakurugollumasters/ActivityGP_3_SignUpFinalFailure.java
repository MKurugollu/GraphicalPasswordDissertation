...
public class ActivityGP_3_SignUpFinalFailure extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_p_3__sign_up_final_failure);
        ...
        backButton = (Button) findViewById(R.id.buttonretrygp3);

        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ActivityGP_3_SignUpFinalFailure.this, ActivityGP_3_SignUpFinal1.class);
