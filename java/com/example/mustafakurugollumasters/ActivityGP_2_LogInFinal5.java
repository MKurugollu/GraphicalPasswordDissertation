...
public class ActivityGP_2_LogInFinal5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_p_2__log_in_final5);
        ...
        FL = (FrameLayout) findViewById(R.id.gp2_fl_5);
    ...
    public void openActivityGP_2_LogInFinal() {
        ...
        for (int i : presses){
            Log.v("press", Integer.toString(i));
        }
        Intent intent;
        if(presses.contains(0))
            intent = new Intent(this, ActivityGP_2_LogInFinalFailure.class);
        else
            intent = new Intent(this, ActivityGP_2_LogInFinalSuccess.class);
