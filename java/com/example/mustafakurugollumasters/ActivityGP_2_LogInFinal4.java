...
public class ActivityGP_2_LogInFinal4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_p_2__log_in_final4);
        ...
        FL = (FrameLayout) findViewById(R.id.gp2_fl_4);
    ...
    public void openActivityGP_2_LogInFinal5() {
        if(isInside){
            presses.add(1);
        }
        else
        ...
        Intent intent = new Intent(this, ActivityGP_2_LogInFinal5.class);
