...
public class ActivityGP_2_LogInFinal1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gp2Items = myDb.getGP2Items(username);
        isInside = false;
    ...
    public void openActivityGP_2_LogInFinal2() {
        if(isInside){
            presses.add(1);
        }
        else
        ...
        Intent intent = new Intent(this, ActivityGP_2_LogInFinal2.class);
