...
public class ActivityGP_2_SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_p_2__sign_up);

        nextButton = (Button)findViewById(R.id.gp2SignUpNext);
        myUsername = (EditText)findViewById(R.id.gp2UsernameField_signup);
        ...
        nextButton.setOnClickListener(
                new View.OnClickListener(){
                    public void onClick(View view){
                        ...
                        openActivityGP_2_SignUpPassword();
                    }
                }
        );
    }
    ...
    public void openActivityGP_2_SignUpPassword() {
        Intent intent = new Intent(this, ActivityGP_2_SignUpPassword.class);
